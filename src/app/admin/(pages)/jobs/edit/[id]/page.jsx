      ...
      <Card className='w-full max-w-2xl'>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className='space-y-6'>
            <JobFormFields formData={formData} handleChange={handleChange} loading={submitting} errors={errors} />
            ...
            <div className='flex justify-end gap-4 pt-4'>
              <Button className='cursor-pointer' type='button' variant='outline' onClick={() => router.push("/admin/jobs")} disabled={submitting}>
                Cancel
              </Button>
              <Button type='submit' disabled={submitting} className='min-w-[120px] cursor-pointer'>
                {submitting ? (
